...
const lambda = require('../../../src/assignments/put-question');

const { statusCode, reponseFormat } = require('../../../src/util')

// This includes all tests for putItemHandler
describe('Test putQuestionHandler', () => {
    let putSpy;
    let getSpy;
    ...
    //Mock data
    const {objSuccess, objUpdate, objfail} = require('../../../MockData/question')
    const assignmentObject = require('../../../MockData/assignment')

    // This test invokes putQuestionHandler and compares the result
    it('should add item', async () => {
        ...
        const result = await lambda.putQuestionHandler(event,"",()=>{});
    ...
    it('should edit item', async () => {
        // Return the specified value whenever the spied put function is called
        getSpy.mockReturnValue({
            promise: () => Promise.resolve(assignmentObject.questionTest),
        });

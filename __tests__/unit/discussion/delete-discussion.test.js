...
const lambda = require('../../../src/discussion/delete-discussion');

const { statusCode, reponseFormat } = require('../../../src/util')

// This includes all tests for putItemHandler
describe('Test deleteDiscussionHandler', () => {
    let deleteSpy;
    ...
    it('should delete item', async () => {
        ...
        const result = await lambda.deleteDiscussionHandler(event,"",()=>{});
        const expectedResult = reponseFormat(statusCode.Success, {BoardID: objSuccess.BoardID})

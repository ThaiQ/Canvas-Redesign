...
const lambda = require('../../../src/thread/delete-thread');

const { statusCode, reponseFormat } = require('../../../src/util')

// This includes all tests for putItemHandler
describe('Test deleteThreadHandler', () => {
    let deleteSpy;
    ...
    //Mock data
    const {objSuccess, objUpdate, objfail} = require('../../../MockData/thread')
    ...
    it('should delete item', async () => {
        ...
        const result = await lambda.deleteThreadHandler(event,"",()=>{});
        const expectedResult = reponseFormat(statusCode.Success, {ThreadID: objSuccess.ThreadID})
